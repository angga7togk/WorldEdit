...
public class WorldUtils {
			...
			for (int y = minY; y <= maxY; y++) {
				for (int z = minZ; z <= maxZ; z++) {
					...
					if (b != null) {
						 ...
						 * entity.setComponents(x - center.getFloorX(), y - center.getFloorY(), z -
						 * center.getFloorZ());
	...
	public static int paste(WEPlayer dat, Position center, BlocksArray copy) {
		 ...
		 * entity.setComponents(center.getFloorX() + entity.x, center.getFloorY() +
		 * entity.y, center.getFloorZ() + entity.z);
		 * entity.spawnToAll();
